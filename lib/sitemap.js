...
/**
 *  Synchronous alias for toXML()
 *  @param {Integer}     max items per sitemap
 *  @return {Object}
 */
Sitemap.prototype.toSitemaps = function (max) {

    var self = this;

    //header
    //TODO: fix header and footer duplication
    ...
    this.urls.forEach( function (elem, index) {
        // When remainder is zero close sitemap and make another
